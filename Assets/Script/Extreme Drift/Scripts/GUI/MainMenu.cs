...
public class MainMenu : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButton(0) && activePanel != Panels.SelectLevel)
        {
            ...
            UnityEngine.Camera.main.fieldOfView = Mathf.Clamp(UnityEngine.Camera.main.fieldOfView, 50, 60);
            UnityEngine.Camera.main.fieldOfView = Mathf.Lerp(UnityEngine.Camera.main.fieldOfView, 50, Time.deltaTime);
        }
        else {
            x = Mathf.Lerp(x, cameraRotateSpeed * 0.01f, Time.deltaTime * 5.0f);
            UnityEngine.Camera.main.fieldOfView = Mathf.Lerp(UnityEngine.Camera.main.fieldOfView, 60, Time.deltaTime);
        }
