...
public class VehicleCamera : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        if (Switch == -1)
        {
            ...
            GetComponent<UnityEngine.Camera>().fieldOfView = Mathf.Clamp(AIControl.CurrentVehicle.speed / 10.0f + 60.0f, 60, 90.0f);
        ...
        else if (Switch < AIControl.CurrentVehicle.cameraView.cameraSwitchView.Count)
        {
            ...
            RenderSettings.flareStrength = 0.3f;
            GetComponent<UnityEngine.Camera>().fieldOfView = 60;
            ...
            GetComponent<UnityEngine.Camera>().fieldOfView = Mathf.Clamp(50.0f - (farDistance / 2.0f), 10.0f, 120.0f);
