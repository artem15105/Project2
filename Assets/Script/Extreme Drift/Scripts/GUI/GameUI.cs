...
public class GameUI : MonoBehaviour
{
   ...
   public bool carPenalty=false;
    ...
    void Awake()
    {
        ...
        if (PlayerPrefs.GetFloat("BestTime" + SceneManager.GetActiveScene().buildIndex.ToString()) != 0.0f)
            panels.gamePlay.bestTime.text = "Best: " + FormatSeconds(PlayerPrefs.GetFloat("BestTime" + SceneManager.GetActiveScene().buildIndex.ToString()));
